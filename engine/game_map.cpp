...
void Map::update(double frameTime)
{
    ...
    for (size_t i = 0; i  < objects.size(); i++)
    {
        ...
        {
            gameInstance.scriptVM.executeLine(objects[i]->updateScripts[j] + "(map.objects[" + (i+1) + "])");
        }
        ...
        for (size_t j = i+1; j < objects.size(); j++)
        {
            ...
            if (objects[i]->willCollide(*objects[j], frameTime, colpos1, colpos2))
            {
                ...
                {
                    gameInstance.scriptVM.executeLine(objects[i]->objectCollisionScripts[k] + "(map.objects[" + (i+1) + "], map.objects[" + (j+1) + "], " +
                ...
                {
                    gameInstance.scriptVM.executeLine(objects[j]->objectCollisionScripts[k] + "(map.objects[" + (j+1) + "], map.objects[" + (i+1) + "], " +
        ...
        gameInstance.scriptVM.executeLine(string("map.objects[") + (i+1) + "][\"tilecollisions\"]={}");
    ...
    for (size_t i = 0; i  < objects.size(); i++)
    {
        if (objects[i]->getDestructionFlag())
        {
            ...
            {
                gameInstance.scriptVM.executeLine(string("map.objects[") + (j+1) + "]=map.objects[" + (j+2) + "]");
                gameInstance.scriptVM.executeLine(string("map.objects[") + (j+1) + "].id=" + j);
            }
            gameInstance.scriptVM.executeLine(string("map.objects[") + (objects.size()+1) + "]=nil");
            i--;
        }
    }
